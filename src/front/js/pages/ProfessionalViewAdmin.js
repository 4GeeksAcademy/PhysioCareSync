...
const ProfessionalViewAdmin = () => {
    ...
    const handleChangePage = useCallback((page) => {
        setPage(page)
        navigate(`/professionalViewAdmin?page=${page}&limit=${limit}`)
    }, [history, limit]);
    ...
    const handleNavigate = (specialistId) => {
        navigate(`/professionalViewAdmin/detail/${specialistId}`);
    };
...
export default ProfessionalViewAdmin;
